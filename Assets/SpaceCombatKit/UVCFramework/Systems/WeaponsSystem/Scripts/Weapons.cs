...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class Weapons : ModuleManager, ILeadTargetInfo
    {
        ...
        protected override void Awake()
        {
            ...
            {
                weaponsTargetSelector.onSelectedTargetChanged.AddListener((selectedTarget) => { UpdateLeadTargetPositions(); });
            }
        }
        ...
        protected virtual void UpdateLeadTargetPositions()
        {
