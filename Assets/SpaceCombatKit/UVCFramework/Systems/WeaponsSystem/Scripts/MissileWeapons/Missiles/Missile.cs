...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class Missile : RigidbodyProjectile
    {
        ...
        protected override void Awake()
        {
            ...
            if (targetProximityTrigger != null)
            {
                targetProximityTrigger.onTriggered.AddListener(Detonate);
            }
        }
        ...
        protected virtual void CheckTrigger()
        {
            ...
            {
                if (colliders[i].attachedRigidbody != null && colliders[i].attachedRigidbody.transform == targetLocker.Target.transform)
                {
